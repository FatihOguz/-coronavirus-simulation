...
public class infectedSociety extends  Society{
    ...
    public infectedSociety(int collisionTime,int socialDistance,int speed,boolean isMask,boolean isInfected) {
